<?php
    ...
    $sql0 = "SELECT SUM(bakiye) as kasa,COUNT(musteri_id) as toplam_musteri FROM musteri";
    $result0 = $conn->query($sql0);
    $row0 = $result0->fetch_assoc();
	
	$sql1 = "SELECT SUM(giden_para) as giden_para,SUM(gelen_para)as gelen_para FROM hesap_cuzdani";
    $result1 = $conn->query($sql1);
    $row1 = $result1->fetch_assoc();
	
	
	
	$sql2 = "SELECT SUM(giden_para+gelen_para) as islem_hacmi FROM hesap_cuzdani where DATE(islem_tarihi)= CURRENT_DATE;";
...
<!-- Approach -->
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Yönetim Paneline Hoş Geldiniz !</h6>
                </div>
                <div class="card-body">
              ...
              <div class="card border-left-primary shadow  py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Bankadaki Toplam Para</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($row0["kasa"])." "; ?>&#8378;</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow  py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Toplam Para Girişi</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($row1["gelen_para"])." "; ?>&#8378;
                </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow  py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Toplam Para Çıkışı</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($row1["giden_para"])." "; ?>&#8378;
                </div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-history fa-2x text-gray-300"></i>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow  py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Toplam Müşteri Sayısı</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row0["toplam_musteri"]; ?>	
                </div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-history fa-2x text-gray-300"></i>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow  py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Günlük İşlem Hacmi<?php echo " (".date("d/m/Y")?>)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo number_format($row2["islem_hacmi"])." "; ?>&#8378;
                </div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-history fa-2x text-gray-300"></i>
