<?php
    ...
    if (isset($_SESSION['loggedIn_cust_id'])) {
        $sql0 = "SELECT * FROM musteri WHERE musteri_id=".$_SESSION['loggedIn_cust_id'];
...
<body>
    <div class="nav-wrapper">
        <div class="topnav" id="theTopNav">
            ...
            <a id="user">Merhaba, &nbsp<?php echo $row["adi"]; ?> !</a>
            <a id="logout" href="/logout_action.php" onclick="return confirm('Emin misiniz?')">Çıkış</a>
            <a id="profile" href="/customer_profile.php">Profilim</a>
        </div>
    </div>
