...
<!-- ########################### Sayfa Başladı  ################################################ -->
        ...
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <form class="border-left border-primary pl-4 mb-4" action="" method="post">
                    <div class="form-group">
                        <input class="border border-info" name="search" size="30" type="text" placeholder="Müşteri Ara..." />
                    </div>
                    <div class="form-group">
                        <select class="border border-info" name="by">
					...
					<div class="form-group">
                        <button class="btn btn-info"type="submit" name="submit" id="search">Ara</button>
                    </div>
                </form>
            ...
            while($row = $result->fetch_assoc()) {
			  ...
			  <div class="card shadow mb-4 border border-success">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><?php echo $row["adi"] . " " . $row["soyadi"]; ?></h6>
				  <!-- dropdown menu-->
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      ...
                      <div class="dropdown-divider"></div>
					  <a class="dropdown-item" href="/edit_customer.php?cust_id=<?php echo $row["musteri_id"] ?>">Düzenle</a>
					  <a class="dropdown-item" href="/transactions.php?cust_id=<?php echo $row["musteri_id"] ?>">Hesap Dökümü</a>
					  
                      <a class="dropdown-item" href="/delete_customer.php?cust_id=<?php echo $row["musteri_id"] ?>">Müşteriyi Sil</a>
                    </div>
                  </div>
				  <!-- dropdown menu End-->
                </div>
