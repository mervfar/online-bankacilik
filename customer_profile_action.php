<?php
    ...
    $sqluser = "SELECT * FROM musteri WHERE musteri_id=".$id;
    ...
    $sql0 = "UPDATE musteri SET email = '$email',
                                 adres = '$address',
                                 kullanici_adi = '$cus_uname'
                            WHERE musteri_id=".$_SESSION['loggedIn_cust_id'];;
?>
<!DOCTYPE html>
<html lang="en">
...
Bildirimler                </h6>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $rowuser["adi"] ?></span>
         ...
         <div class="flex-item">
           <?php
                if (($conn->query($sql0) === TRUE)) { ?>
                    <p id="info" class="alert alert-success" role="alert"><?php echo "Güncelleme Başarılı !"; ?></p>
                <?php
                }
                else { ?>
                    <p id="info" class="alert alert-warning" role="alert"><?php echo "Hata: " . $sql0 . "<br>" . $conn->error . "<br>"; ?></p>
                <?php
                }
            ?>
			<a class="btn btn-primary" href="/customer_profile.php" class="button">Geri</a>
        </div>
