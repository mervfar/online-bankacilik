...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="/admin_home.php">Ana Sayfa</a>
        <a id="label">Müşteriler</a>
        <a href="/customer_add.php">Müşteri Ekle</a>
        <a href="/manage_customers.php">Müşterileri Yönet</a>
        <a href="/sikayetler.php">Müşteri Şikayetleri</a>
        <a id="label">Website Yönetimi</a>
        <a href="/post_news.php">Duyuru/Haber</a>
    </div>
