...
<!-- ########################### Sayfa Başladı  ################################################ -->
          <h1 class="text-info">Lütfen gerekli yerleri doldurunuz...!</h1>
		 
		 <form class="border-left border-primary pl-4" action="customer_add_action.php" method="post" name="myform">
	...
	<div class="row">
		...
		<div class="flex-container">
			...
			<div class="container mt-2">
				...
				<button type="reset" class="reset btn btn-outline-warning" >Sıfırla</button>
