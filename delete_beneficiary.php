<?php
    ...
    if (isset($_GET['cust_id'])) {
        $sql0 = "DELETE FROM musteri_iliskileri WHERE iliskili_id=".$_GET['cust_id']." AND musteri_id=".$_SESSION['loggedIn_cust_id'];
    }
...
<body>
    <div class="flex-container">
        <div class="flex-item">
                <?php
                    if ($success = 1) { ?>
                        <p id="info"><?php echo "Müşteri İlişkisi Başarıyla Silindi !"; ?></p>
                    <?php
                    }
                    else { ?>
