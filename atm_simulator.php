                ...
                <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
                  ...
                  Güvenli Çıkış
                    ...
                    <div class="container-fluid">
                        <!-- ########################### Sayfa Başladı  ################################################ -->
						<div >
						<h1 class="text-info">ATM Simulasyonu</h1>
						<form class="border-left border-primary pl-4" action="atm_simulator_action.php" method="post">
                            
                            <div class="form-group ">
                                <label>Miktar Giriniz  (TL) :</label>
                                <input type="text" name="amt" size="24" required>

                            </div>
                            <div class="form-group ">
                                <label>İşlem Türünü Seçin:</label>
                            </div>
                            <div class="form-check">
                                <div class="form-group ">
                                    <input type="radio" name="type" value="debit" id="debit-radio" checked>
                                    <label id="radio-label" for="debit-radio"><span class="radio ">Para Çek</span></label>
                                </div>
                                <div class="form-group ">
                                    <input type="radio" name="type" value="credit" id="credit-radio">
                                    <label id="radio-label" for="credit-radio"><span class="radio ">Para Yatır</span></label>
                                </div>
                            </div>
                            <div class="form-group ">
