...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="/customer_home.php">Ana Sayfa</a>
        <a href="/customer_transactions.php">İşlem Geçmişi</a>
        <a id="label">Para Transferi</a>
        <a href="/beneficiary.php">EFT - Havale</a>
        <a href="/atm_simulator.php">ATM</a>
        <a id="label">Yardım Masası</a>
        <a href="/post_sikayet.php">Şikayet Kaydı</a>
    </div>
