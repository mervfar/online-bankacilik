...
<body>
    <form class="add_customer_form" action="send_funds_action.php?cust_id=<?php echo $id ?>" method="post">
        <div class="flex-container-form_header">
            <h1 id="form_header">Para Transferi</h1>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                <label>Hesap No : <label id="info_label"><?php echo $row0["hesap_no"] ?></label></label>
            </div>
        </div>

        <div class="flex-container">
            <div class=container>
                <label>Miktar Giriniz (TL) :</label><br>
        ...
        <div class="flex-container">
            <div  class=container>
                <label>Şifrenizi Giriniz :</b></label><br>
