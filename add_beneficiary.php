...
<!-- ########################### Sayfa Başladı  ################################################ -->
         <h1 class="text-danger">Lütfen eklemek istediğiniz kişinin bilgilerini giriniz...</h1>
		 <form class="border-left border-primary pl-4" action="add_beneficiary_action.php" method="post" name="myform">
        ...
        <div class="form-group ">
            ...
            <div class="form-group ">
                ...
                <input name="acno" size="30" type="text" required />
            </div>
        </div>
        <div class="form-group">
            
                <a class="btn btn-primary" href="/beneficiary.php" class="button">Geri</a>
