...
<!-- ########################### Sayfa Başladı  ################################################ -->
         <h1 class="text-danger">Hesap Bilgileriniz...</h1>
		 <form class="border-left border-primary pl-4" action="customer_profile_action.php" method="post" name="myform">
        
            
        <div class="form-group">
            <div class=container>
                <label>Adı : <label id="info_label"><?php echo $fname ?></label></label><br>
            
                <label>Soyadı : <label id="info_label"><?php echo $lname ?></label></label>
            </div>
        
            <div class=container>
                <label>Hesap No : <label id="info_label"><?php echo $acno ?></label></label><br>
           
                <label>Bakiye : <label id="info_label"><?php echo number_format($balance) ?>(&#8378;)</label></label><br>
                ...
                <label>Doğum Tarihi : <label id="info_label"><?php echo $dob ?></label></label><br>
            
                <label>E-Posta :</label>
                <input name="email" size="30" type="text" value="<?php echo $email ?>" required /><br>
            
                <label>Kullanıcı Adı :</label>
                <input name="cus_uname" size="30" type="text" value="<?php echo $cus_uname ?>" required /><br>
            
                <label>Telefon No : <label id="info_label"><?php echo $phno ?></label></label><br>
            ...
            <div class="container">
                <a href="/customer_home.php" class="btn btn-primary">Ana Sayfa</a>
            
                <button type="submit" class="btn btn-success">Güncelle</button>
           
                <a href="/pass_change.php" class="btn btn-outline-dark">Şifre/PIN Değiştir</a>
            </div>
        </div>
