<?php
    ...
    $sql0 = "SELECT musteri_id FROM musteri WHERE adi='$fname' AND
                                                soyadi ='$lname' AND
                                                hesap_no ='$acno'";
    ...
    if ($result->num_rows > 0) {
        ...
        $beneficiary_id = $row["musteri_id"];

        if ($id != $beneficiary_id) {
            $sql1 = "INSERT INTO musteri_iliskileri VALUES(
                        NULL,
                        '$id',
                        '$acno',
						'$beneficiary_id'
...
<!-- ########################### Sayfa Başladı  ################################################ -->
         <div class="flex-item">
		  ...
		  <?php echo "Kendinizi Ekleyemezsiniz !\n"; ?>
		</div>
            <?php } ?>
			<a class="btn btn-primary" href="/add_beneficiary.php" class="button">Geri</a>
        </div>
