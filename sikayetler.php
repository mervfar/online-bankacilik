...
<!-- ########################### Sayfa Başladı  ################################################ -->
          <div id="none"class="alert alert-warning" role="alert">
  Müşteri Şikayetleri
</div>
          <div class="flex-container">
		  <div class="border border-secondary rounded-left" style=" 
					  height:420px;
        ...
        <?php
            ...
            while($row = $result->fetch_assoc()) {
				...
				if ($is_solved==1){$durum = "Problem Çozüldü !";$renk="success";}
				else {$durum = "Problem Çozülmedi !";$renk="danger";}
                ...
                <!-- BASİC CARD -->
						<div class="card shadow mb-4 border border-dark">
							<div class="card-header py-2">
								<div class="row">
									<div class="col">
								  <h2 class="m-0 font-weight-bold text-warning"><?php echo $row["baslik"]; ?></h2>
								  <h6 class="m-0 font-weight-bold text-primary"><?php echo "Tarih : ".date("d/m/Y", strtotime($row["tarih"])); ?></h6>
								  <h6 class="m-0 font-weight-bold text-info">Müşteri:<?php while($row1 = $result1->fetch_assoc()) {
								  echo " ".$row1["adi"]." ".$row1["soyadi"];}?></h6>
									</div>
									<div class="col text-right">
								  <button type="button" class="btn btn-outline-<?php echo$renk?> pl-auto "disabled ><?php echo $durum; ?></button>
									...
									<div class="dropdown no-arrow">
										...
										<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
										  ...
										  <div class="dropdown-divider"></div>
										  <a class="dropdown-item" href="#" value="<?php echo $row["sikayet_id"] ?>">Çözüldü</a>
										  <a class="dropdown-item" href="#" value="<?php echo $row["sikayet_id"] ?>">Çözülmedi</a>
