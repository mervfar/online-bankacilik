<?php
    ...
    $sql0 = "DELETE FROM musteri WHERE musteri_id=".$_SESSION['cust_id'];
    $sql1 = "DELETE FROM hesap_cuzdani WHERE musteri_id=".$_SESSION['cust_id'];
    $sql2 = "DELETE FROM musteri_iliskileri WHERE musteri_id=".$_SESSION['cust_id'];
...
<!-- ########################### Sayfa Başladı  ################################################ -->
        ...
        <div class="flex-item">
            <?php
				...
				<?php echo "Müşteri Başarıyla Silindi!\n"; ?>
				</div>
                <?php
                }
                else { ?>
					...
					<?php echo "Error: " . $sql0 . "<br>" . $conn->error . "<br>"; ?>
					</div>
                <?php
                }
            ?>
        ...
        <div class="flex-item">
            <?php
                if (($conn->query($sql1) === TRUE)) { ?>
					...
					<div class="alert alert-success" role="alert">
					<?php echo "Müşterinin Hesap Cüzdanı Başarıyla Silindi !"; ?>
					</div>
                <?php
                }
                else { ?>
					...
					<div class="alert alert-danger" role="alert">
					<?php echo "Error: " . $sql1 . "<br>" . $conn->error . "<br>"; ?>
					</div>
                <?php
                }
            ?>
        ...
        <div class="flex-item">
            <?php
                if (($conn->query($sql2) === TRUE)) { ?>
					...
					<div class="alert alert-success" role="alert">
					<?php echo "Müşterinin İlişkileri Başarıyla Silindi !"; ?>
					</div>
                <?php
                }
                else { ?>
						...
						<div class="alert alert-danger" role="alert">
						<?php echo "Error: " . $sql2 . "<br>" . $conn->error . "<br>"; ?>
						</div>
                <?php
                }
            ?>
        </div>
		<a class="btn btn-info mt-4" href="/manage_customers.php" role="button">Geri</a>
        <?php $conn->close(); ?>
