...
<!-- ########################### Sayfa Başladı  ################################################ -->
         <h1 class="text-danger">Lütfen paylaşmak istediğiniz sıkınıtıyı giriniz...</h1>
		 <form class="border-left border-primary pl-4" action="post_sikayet_action.php" method="post">
        ...
        <div class="form-group ">
            ...
            <div  class="form-group ">
                <label>Detaylar:</b></label><br>
                <textarea name="sikayet_details" style="height: 200px; width: 60vw;" required /></textarea>
            </div>
